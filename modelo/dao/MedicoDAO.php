...
class MedicoDAO {
    ...
    public function filtrar($min, $max){
      ...
      public function insertar($cedula, $nombre, $apellido, $celular, $genero, $especialidad) {
        //sentencia sql
        $data = [
            'cedula' => $cedula,
            'nombres' => $nombre,
        ...
        $sql = "insert into medico(cedula, nombres, apellidos, celular, genero, especialidad)
        values(:cedula, :nombres, :apellidos,:celular,:genero, :especialidad)";
   ...
   public function actualizar($cedula, $nombre, $apellido, $celular, $genero, $id, $especialidad) {
        //prepare
        $sql = "update medico set cedula = :cedula, nombres = :nombres, 
        apellidos =:apellidos, celular = :celular, genero = :genero, especialidad = :especialidad
        where id = :id";
        //now());
        //bind parameters
        $sentencia = $this->con->prepare($sql);
