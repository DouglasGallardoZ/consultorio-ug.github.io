...
class PacienteController {
    ...
    public function index() {
        ...
        require_once 'vista/paciente/paciente.listar.php';
    }
  ...
  public function buscarAjax() {
    ...
    public function nuevo() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {// insertar el producto
            ...
            //llamar a la vista
            //   $this->index();
            header('Location:index.php?c=paciente&f=index');
        } else {

            // comunicarse con la vista
            require_once 'vista/paciente/paciente.insertar.php';
        }
    }
    ...
    public function editar() {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {// editar
            ...
            // comunicarse con la vista
            require_once 'vista/paciente/paciente.editar.php';
        }
    }
    ...
    public function eliminar() {
        ...
        // $this->index();
        //llamar a la vista
        header('Location:index.php?c=paciente&f=index'); // redireccionamiento, causa un cambio en la url
    }
